...
Write-Output "Creating the consumer group [$ColdStorageConsumerGroupName] for the [$Path] event hub..." 
$ConsumerGroupDescription = New-Object -TypeName Microsoft.ServiceBus.Messaging.ConsumerGroupDescription -ArgumentList $Path, $ColdStorageConsumerGroupName 
$ConsumerGroupDescription.UserMetadata = $ConsumerGroupUserMetadata 
$NamespaceManager.CreateConsumerGroupIfNotExists($ConsumerGroupDescription); 
Write-Output "The consumer group [$ColdStorageConsumerGroupName] for the [$Path] event hub has been successfully created." 

Write-Output "Creating the consumer group [$DispatcherConsumerGroupName] for the [$Path] event hub..." 
$DispatcherGroupDescription = New-Object -TypeName Microsoft.ServiceBus.Messaging.ConsumerGroupDescription -ArgumentList $Path, $DispatcherConsumerGroupName 
$DispatcherGroupDescription.UserMetadata = $ConsumerGroupUserMetadata 
$NamespaceManager.CreateConsumerGroupIfNotExists($DispatcherGroupDescription); 
Write-Output "The consumer group [$DispatcherConsumerGroupName] for the [$Path] event hub has been successfully created." 
